//
//  PlaybackDiagnosticModels.swift
//  Fonic HiFi
//
...
public enum BitPerfectStatus: String, Sendable {
    ...
    public var description: String {
        switch self {
        case .active: "Bit-perfect playback active"
        case .available: "Bit-perfect available but not active"
        case .limited: "Bit-perfect limited by device/format"
        case .unavailable: "Bit-perfect not supported"
        }
    }
}
